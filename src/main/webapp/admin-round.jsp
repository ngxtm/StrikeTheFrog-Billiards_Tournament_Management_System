                ...
                <div class="content-header">
                    ...
                    <div class="content-header-actions">
                        ...
                        <form method="./Dashboard" class="content-header-actions">
                            ...
                            <input type="hidden" name="action" value="add-round"/>
                        </form>
                    </div>
                </div>
                                ...
                                <td>
                                    <div class="actions">
                                        <form action="./Dashboard">
                                            ...
                                            <input type="hidden" name="action" value="edit-round"/>
                                            <input name="round_edit_id" value="<%= list.get(i).getRoundid()%>" type="hidden"/>
                                            <input class="action-button edit-button" type="submit" value="Edit"/>
                                        </form>

                                        <form action="./Dashboard">
                                            <input name="action" value="delete-round" type="hidden"/>

                                            <input name="round_delete_id" value="<%= list.get(i).getRoundid()%>" type="hidden"/>
